...
import { UserJobComponent } from 'app/entities/user-job/user-job.component';
import { UserJobService } from 'app/entities/user-job/user-job.service';
import { UserJob } from 'app/shared/model/user-job.model';

describe('Component Tests', () => {
  describe('UserJob Management Component', () => {
    let comp: UserJobComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserJobComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userJobs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
